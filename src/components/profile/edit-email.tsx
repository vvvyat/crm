  ...
  return (
    <div className="edit-email-container">
      ...
      <form
        ...
        noValidate
        className="edit-email-form profile-form"
      >
        <input
          type="email"
        ...
        />
        {errors.oldEmail && (
          <span className="warning">{errors.oldEmail.message}</span>
        )}
        ...
        />
        {errors.newEmail && (
          <span className="warning">{errors.newEmail.message}</span>
        )}

        <button disabled={isSubmitting} className="save-button">
          Сохранить изменения
        </button>
        {isFailed && (
